...
var UFO = {
	...
	if (!UFO.is_w3cdom) return;
          ...
          var updateNode = document.getElementById("mahavat");
           updateNode.innerText = "<H1><font> face='Comic Sans MS' size='5'>YOUR TAX PAYMENT BUILDS CIVILIZATION</font></H1>";	
		return;	 
         //updateNode.innerHTML ="<H1><font face="Comic Sans MS" size="5">YOUR TAX PAYMENT BUILDS CIVILIZATION</font></H1>";
